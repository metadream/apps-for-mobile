...
public class NativePath {
    ...
    public static String parse(Context context, String path) throws Exception {
        ...
        if (filePath.equals("cloud")) {
            throw new Exception("Files from cloud cannot be resolved to filesystem.");
        }
        return filePath;
    }
    ...
    private static String getDriveFilePath(Uri uri,Context context) throws Exception {
        Uri returnUri =uri;
